...
load data/mini/trSep.dat;          # Muestras entrenamiento (no separable)
load data/mini/trSeplabels.dat     # Etiquetas entrenamiento (no separable)
